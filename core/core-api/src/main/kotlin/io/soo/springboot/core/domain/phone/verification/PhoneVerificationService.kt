...
class PhoneVerificationService(
    ...
    fun createVerification(phoneNumber: String): PhoneVerificationIssueResult {
    ...
    fun confirmVerification(phoneNumber: String, verificationId: String, code: String): PhoneVerificationConfirmResult {
        val normalizedPhone = normalizePhone(phoneNumber)
    ...
    fun consumeVerificationToken(phoneNumber: String, proofToken: String) {
        val normalizedPhone = normalizePhone(phoneNumber)
